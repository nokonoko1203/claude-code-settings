...
- For front-end implementation, please ensure to verify the functionality **using Playwright MCP (or Chrome DevTools MCP)** before considering the work complete.
- If you need to check console logs or other details, please make sure to use the **Chrome DevTools MCP**.
