---
name: humanize-text
description: "AIが書いた日本語の文章を、人間が書いたように自然な日本語へ全面的に書き直す。AI臭さ（テンプレ感、記号過多、過剰な丁寧さ、抽象語の空回り）を完全に除去する。使用トリガー: 'この文章を自然にして', '人間っぽく書き直して', 'AI臭さを消して', 'humanize', '文章をリライトして'"
---
...
# 使い方
ユーザーから文章が渡されたら、上記ルールに従って書き直した文章だけを返す。
